...
# Ensure Windows OpenSSH gets used
...
if [[ "$OSTYPE" == "cygwin" ]]; then
  # Replace abs path with rel off $PATH to keep git-bash happy
...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
  export NODE_EXTRA_CA_CERTS="/c/Users/I1004565/zscaler-root-ca.pem"
fi
